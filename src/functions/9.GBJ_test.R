...
phenoname <- c("POL1","stp10","PNZ1","PBR1")
...
# Save as CSV
for(i in phenoname){
  write.csv(get(paste0(i,"2kbext_omni_maize")),(paste0(i,"_omni_maize_2kbext.csv")), row.names = FALSE)
}
...
#Save as RDS
for(i in phenoname){
  saveRDS(get(paste0(i,"2kbext_omni_maize")),(paste0(i,"_omni_maize_2kbext.RDS")))
}
