...
sorghum_MAGMA <- read.csv(paste0(dir,"sorghum/Top_MAGMA_hits_sorghum_4pheno.csv"))
...
write.csv(sorghum_MAGMA,"Combined_MAGMA_sorghum_4pheno.csv",row.names = F)
...
# From combining_data_omni_magma
#maize_MAGMA <- total_magma
dir <- "~/Library/Mobile Documents/com~apple~CloudDocs/Research/Results/Top_MAGMA_hits/"
# From combining_data_omni_magma
maize_MAGMA <- total_magma
maize_MAGMA <- read.csv(paste0(dir,"maize/Top_MAGMA_hits_maize_4pheno.csv"))
...
#write.csv(maize_omni,"combined_maize_omni.csv",row.names = F)
write.csv(maize_MAGMA,"Combined_MAGMA_maize_4Pheno.csv",row.names = F)
